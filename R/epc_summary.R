...
epc_summarise_domestic = function(path = file.path(parameters$path_data,"epc/GB_domestic_epc.Rds"),
  ...
  cert_summ <- dplyr::summarise(cert_summ,
              ...
              age_19001929 = length(age[tenure == "1900-1929"]),
              age_19301949 = length(age[tenure == "1930-1949"]),
              age_19501966 = length(age[tenure == "1950-1966"]),
              age_19671975 = length(age[tenure == "1967-1975"]),
              age_19761982 = length(age[tenure == "1976-1982"]),
              age_19831990 = length(age[tenure == "1983-1990"]),
              age_19911995 = length(age[tenure == "1991-1995"]),
              age_19962002 = length(age[tenure == "1996-2002"]),
              age_20032006 = length(age[tenure == "2003-2006"]),
              age_post2012 = length(age[tenure == "2012 onwards"]),
